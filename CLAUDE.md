...
### Images (three sources, never crossed; updated 2026-07-19 per Oleg)
- **Always real, never generated:** the named author's photo, and any image presented as a
  real person, real review, or the operator's actual product. Operator/Viator photos are
  the preferred upgrade whenever supplied.
- **AI-generated photography (the DEFAULT for heroes, cards, section and blog images,
  per-site approval recorded in site.config.md):** generated with the ChatGPT image API
  (newest gpt-image-* model) and MANDATORY passed through the AI-detector critique loop
  until a vision model judges it "not AI-looking". Unbranded original scene designs
  only, no logos, no text, no recognizable faces. Full recipe: `.claude/03-design-system.md`
  > 3.4c. (Grok imagine remains a fallback only.)
- **Hand-authored by Claude (never AI-image-generated):** the logo, favicon, and all data
  infographics (SVG; image models garble text and numbers).
...
| Build or edit a page block / define a partial | `04-block-library.md`, `03-design-system.md`, `09-conversion.md` |
| Build an individual tour (money) page | `04-block-library.md`, `05-technical-seo.md`, `01-research-pipeline.md`, `09-conversion.md` |
| Write titles / meta / schema / technical SEO | `05-technical-seo.md` |
| Write an article / any content or copy | `06-content-engine.md`, `04-block-library.md`, `09-conversion.md` |
| AEO: single-question page, /ai-learn-about-us, llms.txt | `07-aeo-llm.md` |
| Maximize affiliate clicks / CRO pass / CTAs / sticky bar | `09-conversion.md` + skill `conversion-optimizer`, then `04-block-library.md` |
...
- `09-conversion.md` — build-time CRO: CTA set, cadence, sticky bar, honesty gates (Phase 9)
