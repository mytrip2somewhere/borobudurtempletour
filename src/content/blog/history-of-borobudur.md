...
What is not argued about is that the same century, in the same region, produced a huge Hindu complex too. I have written about what that overlap means in [the Prambanan question](/blog/is-prambanan-hindu-or-buddhist/), because it is the single most interesting fact about 9th-century Java and it almost never gets told properly.
...
<figure class="infographic">
 <img src="/images/generated/history-of-borobudur.svg" alt="Timeline of Borobudur's history from construction beginning in 778 AD, through completion around 825 AD, the Javanese court's move east in 929 AD, disuse between the 10th and 15th centuries, the 1814 clearing under Raffles, UNESCO listing in 1991, and the climb reopening today" width="900" height="470" loading="lazy">
 <figcaption class="small">Twelve centuries in one line: built in fifty years, quietly left, cleared in 1814, listed in 1991.</figcaption>
</figure>

<aside class="infogain">
  <p class="infogain-h"><span class="tag">Latest data</span> What researchers are still pulling out of the stone</p>
  <ul>
    <li>The carved surface is not a handful of panels. UNESCO puts the reliefs on the walls and balustrades at about 2,520 square metres of worked stone.</li>
    <li>A 2025 study in the journal Taprobanica examined 160 Karmawibhangga panels from the hidden base and identified 52 species of archaeofauna carved into them, which makes the reliefs a record of 9th-century Javanese wildlife as well as a religious text.</li>
    <li>Counting everything decorative as well as narrative, the monument is commonly totalled at 2,672 relief panels and 504 Buddha statues; the 1,460 figure covers the narrative panels alone.</li>
    <li>The block count is an estimate rather than a census, but roughly two million stones are generally reckoned to be in the structure.</li>
    <li>About 1.3 million people visited in 2024, around 200,000 of them from overseas.</li>
  </ul>
...
There is more on this, including the sources, in the [why was Borobudur abandoned](/guides/why-was-borobudur-abandoned/) guide.
...
My honest advice: give up on seeing everything, pick the first gallery, and walk it in the right direction with someone who can tell you what you are looking at. A guide comes with the climb ticket by default, which is the single most underrated thing about how Borobudur is now ticketed. There is more on how that works in the [climbing Borobudur](/guides/climbing-borobudur/) guide, and on time budgets in [how long to spend at Borobudur](/guides/how-long-at-borobudur/).

If you want the version of the day that actually gets you onto the terraces with time to use them, the [Sunrise Climb &amp; Prambanan tour](/tours/borobudur-sunrise-climb-prambanan/) is the one I would point a first-time visitor at; you can <a href="https://www.getyourguide.com/yogyakarta-l349/yogyakarta-borobudur-climbup-guarantee-and-prambanan-tour-t516797/?partner_id=MME1WGW&utm_medium=online_publisher" rel="sponsored noopener" target="_blank">check live availability &amp; prices on GetYourGuide</a> for your date. It guarantees the climb ticket, which matters, because the climb is the only way onto the galleries.

And if you are weighing this against the other great temple in the region's conversation, [Borobudur or Angkor Wat](/blog/borobudur-or-angkor-wat-which-to-visit/) takes that one apart honestly, including the size claim everyone gets wrong.
